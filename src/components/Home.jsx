...
export default function Home() {
  ...
  return (<>
    <motion.div variants={fadeIn("up",0.2)} initial="hidden" whileInView={'show'} viewport={{once:false,amount:0.3}} id='home' className='section pt-28 lg:pt-36 z-10'>
      ...
      <ReactTyped strings={['Full Stack developer','.NET Core','React.Js','Next.Js','Angular.Js']} className='headline-2 text-center relative' typeSpeed={100} backSpeed={50} loop={true} loopCount={Infinity} startDelay={1500} showCursor={false}/>
